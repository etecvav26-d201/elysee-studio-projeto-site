...
<body>
    ...
    <main>
        ...
        <section class="intro section" id="conheca">
        ...
        <section class="journal" id="portifolio">
            <div class="container">
                <div class="section-heading journal-heading">
                    <div>
                        <h2 class="display-title reveal">Portifólio de <em>Atendimentos</em></h2>
                    </div>
                </div>
